<script lang="ts">
    ...
    type AvailableColumn = {
        value: keyof Treatments,
        label: string
    }
    
    // function to close edit and create modal
...
<div class="grid gap-4 p-4 sm:grid-cols-2">
    ...
    <div class="relative">
        ...
        <div class="bg-gray-50 p-4 mt-4 transition duration-300 rounded-lg hover:bg-gray-100 border-2 border-gray-200">
            ...
            <Button variant="outline" type="button" class="absolute top-0 -right-0 p-2" on:click={() => isOpen = true}>
            ...
            <div class="grow ms-6">
                ...
                <div class="flex items-center justify-between mt-1 gap-2">
                    ...
                    <button type="button" class="bg-gray-200 rounded-lg shadow-lg px-1.5 py-1" on:click={() => {isAlertDeleteOpen = true}}>
        ...
        <AlertDialog.Content>
            ...
            <AlertDialog.Footer>
                ...
                <form action="?/deleteTreatment" method="POST" use:enhance>
                    <input type="text" name="id" id="id" class="hidden" value={treatment?.id}>
